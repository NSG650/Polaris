...
sym_table_t symbol_table[] = {
	...
	{0xffffffff80009a98, "lai_read_buffer"},
	{0xffffffff80009b2b, "lai_write_buffer"},
	{0xffffffff8000a61f, "lai_parse_u32"},
	{0xffffffff8000a665, "lai_exec_pop_blkstack_back"},
	{0xffffffff8000a688, "lai_exec_pop_stack_back"},
	{0xffffffff8000a6ab, "lai_exec_push_ctxstack"},
	{0xffffffff8000a700, "lai_exec_push_blkstack"},
	{0xffffffff8000a757, "lai_exec_push_stack"},
	{0xffffffff8000a789, "lai_exec_push_opstack"},
	{0xffffffff8000a7e8, "lai_parse_varint"},
	{0xffffffff8000a908, "lai_exec_commit_pc"},
	{0xffffffff8000a933, "lai_exec_reserve_ctxstack"},
	{0xffffffff8000a9ce, "lai_exec_reserve_blkstack"},
	{0xffffffff8000aa6f, "lai_exec_reserve_stack"},
	{0xffffffff8000ab1b, "lai_parse_name"},
	{0xffffffff8000ab3f, "lai_exec_reduce_node"},
	{0xffffffff8000b28c, "lai_exec_reduce_op"},
	{0xffffffff8000eb95, "lai_cleanup_free_string"},
	{0xffffffff8000ebc0, "lai_exec_parse"},
	{0xffffffff80014d72, "lai_exec_process"},
	{0xffffffff80016ce3, "lai_exec_run"},
	...
	{0xffffffff80017910, "lai_eval_vargs"},
	...
	{0xffffffff8000a595, "lai_exec_get_integer"},
	{0xffffffff8000988a, "lai_is_name"},
	{0xffffffff8000a56d, "lai_exec_get_objectref"},
	{0xffffffff80000c7f, "apic_timer_init"},
	{0xffffffff800098e9, "bswap64"},
	{0xffffffff80016d26, "lai_init_state"},
	...
	{0xffffffff80017a62, "lai_enable_tracing"},
	...
	{0xffffffff80009e3f, "lai_exec_ref_store"},
	...
	{0xffffffff80009bea, "lai_exec_string_length"},
	...
	{0xffffffff80016f68, "lai_populate"},
	{0xffffffff8001f9da, "lai_init_children"},
	{0xffffffff8000691d, "vec_swap_"},
	{0xffffffff80016da0, "lai_finalize_state"},
	...
	{0xffffffff800172c6, "lai_eval_args"},
	...
	{0xffffffff80009d1f, "lai_operand_load"},
	...
	{0xffffffff80009eac, "lai_exec_mutate_ns"},
	...
	{0xffffffff800179cd, "lai_eval_largs"},
	...
	{0xffffffff80009c4a, "lai_exec_access"},
	{0xffffffff80018f18, "lai_create_root"},
	{0xffffffff8000a2fd, "lai_operand_emplace"},
	{0xffffffff80019712, "lai_ns_get_node_type"},
	{0xffffffff80008dc7, "ssfn_utf8"},
	{0xffffffff80017a4c, "lai_eval"},
	{0xffffffff80009c13, "lai_exec_pkg_var_load"},
	...
	{0xffffffff80009cb2, "lai_exec_ref_load"},
	...
	{0xffffffff8000a08d, "lai_operand_mutate"},
