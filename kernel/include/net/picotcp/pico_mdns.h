 ...
 * ****************************************************************************/
int pico_mdns_record_cmp(void *a, void *b);
 ...
 * ****************************************************************************/
int pico_mdns_record_delete(void **record);
 ...
 * ****************************************************************************/
struct pico_mdns_record *pico_mdns_record_create(struct pico_stack *S,
												 const char *url, void *_rdata,
												 uint16_t datalen,
												 uint16_t rtype, uint32_t rttl,
												 uint8_t flags);
...
#define PICO_MDNS_RTREE_ADD(tree, record) pico_tree_insert((tree), (record))
 ...
 * ****************************************************************************/
int pico_mdns_getrecord(struct pico_stack *S, const char *url, uint16_t type,
 ...
 * ****************************************************************************/
int pico_mdns_claim(struct pico_stack *S, pico_mdns_rtree record_tree,
					void (*callback)(pico_mdns_rtree *, char *, void *),
					void *arg);
 ...
 *  @return 0 when the host started registering the hostname-record
 * successfully, Returns something else when it didn't succeeded.
 * ****************************************************************************/
int pico_mdns_tryclaim_hostname(struct pico_stack *S, const char *url,
								void *arg);
 ...
 * ****************************************************************************/
const char *pico_mdns_get_hostname(struct pico_stack *S);
 ...
 *	@param arg		Argument to pass to the init-callback.
 *  @return 0 when the module is properly initialised and the host started
 *regis- tering the hostname. Returns something else went the host failed
 *			initialising the module or registering the hostname.
 * ****************************************************************************/
int pico_mdns_init(struct pico_stack *S, const char *hostname,
