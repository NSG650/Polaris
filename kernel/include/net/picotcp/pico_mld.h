...
#define MLD_MULTICAST_LISTENER_INTERVAL \
	(MLD_ROBUSTNESS * MLD_QUERY_INTERVAL) + MLD_QUERY_RESPONSE_INTERVAL
#define MLD_OTHER_QUERIER_PRESENT_INTERVAL \
	(MLD_ROBUSTNESS * MLD_QUERY_INTERVAL) + (0.5 * MLD_QUERY_RESPONSE_INTERVAL)
...
int pico_mld_state_change(struct pico_stack *S, struct pico_ip6 *mcast_link,
						  struct pico_ip6 *mcast_group, uint8_t filter_mode,
