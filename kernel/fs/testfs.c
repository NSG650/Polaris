...
uint32_t testfs_read(struct file *this, size_t count, size_t offset, uint8_t *out) {
...
uint32_t testfs_write(struct file *this, size_t count, size_t offset, uint8_t *in) {
    spinlock_acquire_or_wait(this->lock);
